function [ center, radius ] = generateBoundedSphere( triangle_vertices )
    %Generates a bounding sphere around a triangle in order to simplify
    %finding the closest point on a mesh.
    %INPUT: The vertices of a triangle to be bounded
    %OUTPUT: The center and radius of the resulting bounding sphere.
